...
(my/defkeymap my-org-prefix-map "ORG"
  ("d" "insert-Drawer"       #'my/org-insert-drawer-custom)
  ("f" "pair-pairs-Wrap"     #'my/pair-pairs-wrap)
  ("i" "Insert-prefix-block" #'my/org-insert-custom-prefix-to-blocks)
  ("w" "wrap symbol"         #'my/org-wrap-with-symbol-smart))
